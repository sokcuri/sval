(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var allowApis = __spread(Object.keys(globals.builtin), Object.keys(globals["shared-node-browser"]));
    try {
        if (!window.Object)
            throw 0;
        names = getOwnNames(globalObj = window).filter(function (n) { return n !== 'webkitStorageInfo'; }).filter(function (x) { return allowApis.includes(x); });
    }
    catch (err) {
        try {
            if (!global.Object)
                throw 0;
            names = getOwnNames(globalObj = global).filter(function (n) { return n !== 'GLOBAL' && n !== 'root'; }).filter(function (x) { return allowApis.includes(x); });
        }
        catch (err) {
            try {
            ...
            names = getOwnNames(globalObj).filter(function (x) { return allowApis.includes(x); });
        }
    }
    if (globalObj.Symbol) {
    ...
    var Sval = (function () {
        function Sval(options) {
            ...
            this.exports = {};
            var _a = options.ecmaVer, ecmaVer = _a === void 0 ? 9 : _a;
        ...
        Object.defineProperty(Sval.prototype, "window", {
            get: function () {
